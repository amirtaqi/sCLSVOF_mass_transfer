...
#include "timeVaryingPsiContactAngleFvPatchScalarField.H"
...
Foam::timeVaryingPsiContactAngleFvPatchScalarField::
timeVaryingPsiContactAngleFvPatchScalarField
(
    const fvPatch& p,
...
timeVaryingPsiContactAngleFvPatchScalarField
(
    const timeVaryingPsiContactAngleFvPatchScalarField& gcpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::timeVaryingPsiContactAngleFvPatchScalarField::theta
(
...
void Foam::timeVaryingPsiContactAngleFvPatchScalarField::write
(
    Ostream& os
) const
{
