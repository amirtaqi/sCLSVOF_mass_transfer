...
namespace Foam
{
    defineTypeNameAndDebug(psiContactAngleFvPatchScalarField, 0);

    template<>
    const char* Foam::NamedEnum
    <
        Foam::psiContactAngleFvPatchScalarField::limitControls,
        4
    >::names[] =
    {
        "none",
...
<
    Foam::psiContactAngleFvPatchScalarField::limitControls,
    4
> Foam::psiContactAngleFvPatchScalarField::limitControlNames_;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::psiContactAngleFvPatchScalarField::psiContactAngleFvPatchScalarField
(
    const fvPatch& p,
...
Foam::psiContactAngleFvPatchScalarField::psiContactAngleFvPatchScalarField
(
    const psiContactAngleFvPatchScalarField& acpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::psiContactAngleFvPatchScalarField::evaluate
(
...
void Foam::psiContactAngleFvPatchScalarField::write
(
    Ostream& os
) const
{
